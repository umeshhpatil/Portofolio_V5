...
const ContactPage = () => {
  ...
  return (
    <>
      ...
      <div
        className="h-auto py-10 flex items-center justify-center  min-h-screen px-[5%] md:px-0"
        id="Contact"
      >
        <div className="container px-[1%] grid grid-cols-1 sm:grid-cols-1 md:grid-cols-1 lg:grid-cols-[45%_55%] 2xl:grid-cols-[45%_65%] gap-12 ">
          <div
            data-aos="fade-right"
          ...
          >
            ...
            <form 
              action="https://formsubmit.co/umeshpatil.up09@gmail.com"
              method="POST"
